...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            ...
            print("\n@@@ Operação falhou! Ovalor informado é inavalido. @@@")
...
class Saque(Transacao):
    ...
    def registrar(self, conta):
        sucesso_transacao = conta.sacar(self, self.valor)
...
def criar_cliente(numero_conta,clientes, contas):
    ...
    endereco = input("Informe o enedereço (logadouro, nro - bairro - cidade/sigla estado): ")
